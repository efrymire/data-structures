...
var content = fs.readFileSync('week_01_data/m08.txt')
...
function cleanseDetails() {
    ...
    for (i in address1) {
    if (address1[i] == '91 Claremont Avenue  @ The Cloisters Club Room') {
        address1[i] = '91 Claremont Avenue' }
